---
name: aws-iam
description: "Use when designing AWS security -- IAM policies, least privilege, Secrets Manager vs Parameter Store, KMS, IRSA/OIDC, permission boundaries, SCPs, CloudTrail, secret rotation, or compliance."
user-invocable: true
