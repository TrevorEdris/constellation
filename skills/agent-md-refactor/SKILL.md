...
description: "Use when an AGENTS.md, CLAUDE.md, or similar agent-instruction file is bloated, monolithic, or hard to navigate and needs splitting into organized, linked, progressive-disclosure docs."
