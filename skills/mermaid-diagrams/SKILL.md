...
description: "Use when creating, visualizing, or documenting software with diagrams -- class, sequence, flowchart, ERD, C4, state, git graph, gantt, or pie -- or when asked to diagram, visualize, model, map out, or show the flow of architecture, schemas, or code."
tags: [documentation]
---
